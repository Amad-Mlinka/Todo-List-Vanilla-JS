    ...
    todoList.todos.forEach((todo, i) => {
        var todoItem = $(`<div class="todoItem">
            <div class="checkDescription">
                <div class="todoCheck"><input  type="checkbox" ${todo.completed ? "checked" : ""} class="checkCircle"></input></div>
                <div class="todoDescription">
                    <span class="todoText">${todo.title}</span>
                </div>
            </div>

            <div class="todoDelete" onclick=${()=>{todoList.deleteTodo(i);console.log(i)}}>
                <img
                    class="deleteIcon"
