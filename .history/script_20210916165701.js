...
const renderTodoItem = (todo, i) => {/*Function for populating the view with todos and assigning event listeners */
    ...
    todoDelete.click(function () {
        ...
        $(this).parent().find(".todoDescription").addClass("descriptionMarked")
        $(this).find(".deleteWarning").show();

        setInterval(() => {
            $(this).find(".deleteWarning").hide()
            $(this).parent().find(".todoDescription").removeClass("descriptionMarked")
        }, 3000)
...
$(async () => {
    ...
    /*Sidebar open/close, currently empty, but the sidebar is there */
    hamburger.click(function () {
        $(this).hasClass("open") ? $(this).removeClass("open") : $(this).addClass("open")
        $(".container").hasClass("open") ? $(".container").removeClass("open") : $(".container").addClass("open")
        $(".sidebar").hasClass("open") ? $(".sidebar").removeClass("open") : $(".sidebar").addClass("open")
    })


    /*Get todo list, either by getting it fresh from the api or from local storage if one exists */
